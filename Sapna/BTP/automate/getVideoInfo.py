...
itagpriority = [315, 313, 308, 266, 271, 299, 264, 303, 137, 298, 248, 138, 302, 136, 247, 135, 244, 134, 243, 133, 242, 140, 160, 251, 278, 171, 250, 249]
labels = {171: ["0p", "na", "0", "audio/webm"], 133: ["240p", "426x240", "24", "video/mp4"], 134: ["360p", "640x360", "24", "video/mp4"], \
          ...
          248: ["1080s", "1920x960", "30", "video/webm"], 249: ["0p", "na", "0", "audio/webm"], 250: ["0p", "na", "0", "audio/webm"], 251: ["0p", "na", "0", "audio/webm"]}
...
def getData(youtubeId = "i_XE_3jMudA"):
    url = "https://www.youtube.com/get_video_info?video_id=%s&el=embedded&ps=default&eurl=&gl=US&hl=en"%(youtubeId)
#     print url
...
if __name__ == "__main__":
    ...
    output_file_name = "video_info.json"
